...
// 3. In code, iterate through the array and programmatically create new Album 
// class instances based on each album within the array. You’ll also need to add 
// these instances to the player.

// 4. Add a play button to the web page. When the user selects an artist/album 
// from the drop down menu and clicks the play button, the play() method should 
// be called for that album. This will track that album as being played.

// 5. When the user clicks the “show my favorite album” button, the favoriteAlbum() 
// method should be called and the user’s favorite album based on number of 
// plays should be displayed in the web page.
